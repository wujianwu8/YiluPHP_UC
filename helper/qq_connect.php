 ...
 */
require_once(__DIR__."/qq_connect/Oauth.class.php");

/*
 * @brief QC类，api外部对象，调用接口全部依赖于此对象
 * */
class qq_connect extends Oauth{
    private $keysArr, $APIMap;

    //设置相关接口所需值
    private function _initKeysArr($access_token = "", $openid = ""){
    ...
    public function __construct($access_token = "", $openid = ""){
        parent::__construct();
        $this->_initKeysArr($access_token, $openid);
