...
<?php
$head_info = [
    'title' => $app->lang('add_lang_pack_project'),
];
?>
...
<form class="needs-validation title_content" novalidate="" method="post">
    <div class="row mb-2">
        <div class="col-sm-3 title">
            <label for="project_key"><?php echo $app->lang('project_key'); ?></label>
        </div>
        <div class="col-sm-9">
            <input type="text" class="form-control" id="project_key" name="project_key" placeholder="<?php echo $app->lang('key_rule_notice'); ?>" required="" maxlength="30">
        </div>
    </div>
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-9">
            <input type="text" class="form-control" id="project_name" name="project_name" placeholder="<?php echo $app->lang('can_be_a_language_key_name'); ?>" required="" maxlength="40">
        </div>
    </div>
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-9">
            <input type="text" class="form-control" id="file_dir" name="file_dir" placeholder="<?php echo $app->lang('lang_pack_storage_dir', ['type'=>'PHP']); ?>" required="" maxlength="200">
        </div>
    </div>
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-9">
            <input type="text" class="form-control" id="js_file_dir" name="js_file_dir"
                   placeholder="<?php echo $app->lang('lang_pack_storage_dir', ['type'=>'JS']); ?>" required="" maxlength="200">
        </div>
    </div>
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-9">
            <input type="text" class="form-control" id="language_types" name="language_types" placeholder="<?php echo $app->lang('support_lang_type_rule_brief_notice'); ?>" required="" maxlength="200">
