...
<div class="table-responsive">
    <table class="table table-striped table-sm" id="all_feedback_list">
        <thead>
        <tr>
            <th>ID</th>
            <th></th>
...
<script>
    ...
    $("#all_feedback_list").find("select").change(function(){
        changeFeedbackStatus($(this));
    });
    ...
    $("#all_feedback_list").click(function(e){
        var obj = null;
