...
<?php
$head_info = [
    'title' => YiluPHP::I()->lang('edit_menu'),
];
?>
...
<form class="needs-validation" novalidate="" method="post">
    ...
    <div class="d-block my-3">
        <label><?php echo YiluPHP::I()->lang('menu_position'); ?></label>
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            ...
            <select class="custom-select d-block w-100" id="parent_menu" name="parent_menu"
                <?php echo $menu_info['type']=='SYSTEM'?'disabled' :''; ?> >
                <option value="0" <?php echo $menu_info['parent_menu']==0?'selected' : ''; ?> ><?php echo YiluPHP::I()->lang('top_level'); ?></option>
                <?php
                    $position = '';
    ...
    <div class="mb-3">
        <label for="lang_key">
            <?php echo YiluPHP::I()->lang('menu_name'); ?>
            (<?php echo YiluPHP::I()->lang($menu_info['lang_key']); ?>)
        </label>
        <input type="text" class="form-control" id="lang_key" name="lang_key" placeholder="<?php echo YiluPHP::I()->lang('can_be_a_language_key_name'); ?>"
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="active_preg" name="active_preg" placeholder="<?php echo YiluPHP::I()->lang('regexp_such_as'); ?>"
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="href" name="href" placeholder="<?php echo YiluPHP::I()->lang('jump_link'); ?>" value="<?php echo $menu_info['href']; ?>"
            <?php echo $menu_info['type']=='SYSTEM'?'disabled' :''; ?> >
    </div>

    <div class="mb-3">
        <label for="link_class"><?php echo YiluPHP::I()->lang('link_class'); ?></label>
        <input type="text" class="form-control" id="link_class" name="link_class" placeholder="<?php echo YiluPHP::I()->lang('additional_class_for_the_link'); ?>" value="<?php echo $menu_info['link_class']; ?>"
            <?php echo $menu_info['type']=='SYSTEM'?'disabled' :''; ?> >
    </div>
    ...
    <div class="mb-3">
        ...
        <input type="number" class="form-control" id="weight" name="weight" placeholder="<?php echo YiluPHP::I()->lang('the_bigger_number_the_later'); ?>" required="" value="<?php echo $menu_info['weight']; ?>">
        <div class="invalid-feedback">
